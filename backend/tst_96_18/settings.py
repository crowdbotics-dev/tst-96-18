"""
Django settings for tst_96_18 project.
...
WSGI_APPLICATION = 'tst_96_18.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_96_18 API",
    "DESCRIPTION": "API documentation for tst_96_18 App",
    "VERSION": "v1",
}
